...
export const Navbar:React.FC = () => {
    ...
    const handleEntryKey = (e:React.KeyboardEvent<HTMLInputElement>)=>{
        ...
        <nav className="navbar">
            ...
            <Link to="/catalog" className="navbar-option navbar-link"> 
                ...
                <div className="navbar-search-box">
                    <input className="navbar-search-input" placeholder="Search catalog" onKeyDown={handleEntryKey} ref={searchRef}/>
